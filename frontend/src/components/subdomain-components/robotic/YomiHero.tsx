        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 4 }}>
          ...
          <Box sx={{ flex: { xs: '1 1 100%', md: '1 1 41.666667%' } }}>
            ...
            >
              <Card
                sx={{
                  background: 'rgba(26, 26, 26, 0.95)', // Charcoal with opacity
                  backdropFilter: 'blur(20px)',
                  borderRadius: 3,
                  p: 3,
                ...
                <CardContent sx={{ position: 'relative', zIndex: 1 }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', mr: 2 }}>
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                          sx={{
                            color: i < 5 ? '#FFD700' : 'rgba(255, 255, 255, 0.2)',
                            fontSize: '1.2rem',
                            filter: i < 5 ? 'drop-shadow(0 0 5px rgba(255, 215, 0, 0.5))' : 'none'
                          }}
                        />
                      ))}
                    </Box>
                  ...
                  <Box
                    sx={{
                      mt: 3,
                      p: 2,
                      background: 'linear-gradient(135deg, #c2ae7b 0%, #3d3d3d 100%)',
                      borderRadius: 2,
                      textAlign: 'center',
                      position: 'relative',
                      overflow: 'hidden',
