      ...
      <defs>
        ...
        <radialGradient id={`${screwId}-outer`} cx="0.3" cy="0.3" r="1">
          <stop offset="0%" stopColor={
            ...
            metalType === 'platinum' ? '#FFFFFF' : '#fafafa'
          } />
          <stop offset="15%" stopColor={
            metalType === 'gold' ? '#f5d76e' : 
            metalType === 'platinum' ? '#F5F5F5' : '#f0f0f0'
          } />
          <stop offset="30%" stopColor={
            metalType === 'gold' ? '#f8c059' : 
            metalType === 'platinum' ? '#e3e3e3' : '#e0e0e0'
          } />
          <stop offset="50%" stopColor={
            metalType === 'gold' ? '#D4AF37' : 
            metalType === 'platinum' ? '#999999' : '#c0c0c0'
          } />
          <stop offset="70%" stopColor={
            metalType === 'gold' ? '#b8860b' : 
            metalType === 'platinum' ? '#8b6914' : '#a0a0a0'
          } />
          <stop offset="85%" stopColor={
            metalType === 'gold' ? '#a07605' : 
            metalType === 'platinum' ? '#6b5b00' : '#808080'
          } />
          <stop offset="100%" stopColor={
            metalType === 'gold' ? '#8b6914' : 
            metalType === 'platinum' ? '#5a4a00' : '#606060'
          } />
        </radialGradient>
